...
const ALL_PAGES = [
  ...
  'installation', 'manufacturing', 'supervisor', 'supervisor-input', 'legend-vision', 'top-up-nuera', 'design-studio', 'storeroom', 'wasteroom'
];
...
const RAW_MENU = [
  ...
  { type: 'item', name: 'Virtual Wasteroom 3D',   path: '/wasteroom',          icon: '🗑️', key: 'wasteroom' },
